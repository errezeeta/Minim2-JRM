...
public class MainMenu extends AppCompatActivity {
    ...
    RelativeLayout rellayNewGame, rellayMyItems, rellayStore, rellayMyProfile, rellayStatistics, rellayLogout, rellayLogros;
    Credentials c;
    Toast toast;
    MainMenu main = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rellayLogros =this.findViewById(R.id.BtnLogros);
        ...
        rellayLogros.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainMenu.this, Activity_Logros.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
